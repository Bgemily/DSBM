...
for (id_split in 1:split) {
  ...
  method = 'main_v5_pdf_gamma0.0003'
  for (freq_trun in c(4)){
    ### N_node
    for (i in 1:length(N_node_persubj_list)) {
      N_node = N_node_persubj_list[[i]]
  ...
  method = 'main_v5_pdf_gamma0.0001'
  for (freq_trun in c(4)){
    ### N_node
    for (i in 1:length(N_node_persubj_list)) {
      N_node = N_node_persubj_list[[i]]
