...
params: 
  ...
  data_folder: "../../Results/Rdata/RDA/CDF_v16_sameNclus_Nrestart20_freqtrun2_totaltime200/"
---
...
ICL_history_list = compl_log_lik_history_list = list()
for(m in 1:length(path_vec)){ 
  path = path_vec[m]
...
```{r}
for (ind_subj in 1:length(ICL_history_list)) {
