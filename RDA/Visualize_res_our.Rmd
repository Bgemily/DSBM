...
params: 
  ...
  data_folder: "../../Results/Rdata/RDA/CDF_cut_intens_Ngrid15_fix_v/"
---
...
for (ind in 1:length(center_pdf_array_list)) {
  if (max(center_pdf_array_list[[ind]])>1e5) {
...
g1 = plot_pdf_array_v2(pdf_array_list = center_pdf_array_list[[1]][order_clus_1,order_clus_1, ,drop=FALSE], 
                        ...
                        t_vec = t_vec, x_lim = c(0,250), y_lim = c(0,max(unlist(center_pdf_array_list[[1]]))))
...
g2 = plot_pdf_array_v2(pdf_array_list = center_pdf_array_list[[2]][order_clus_2,order_clus_2, ,drop=FALSE], 
                        ...
                        t_vec = t_vec, x_lim = c(0,250), y_lim = c(0,max(unlist(center_pdf_array_list[[2]]))))
