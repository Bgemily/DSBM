...
option_list = list(
  make_option(c("-n", "--N_trial"), type="integer", default=150, 
              help="number of repeated trials"),
  make_option("--split", type="integer", default=15)
); 
...
# default_setting = 'pr=0.9,n=60,beta=1.9,V=80,N_grid=10'
