...
setup = 'SNR_Vnot0_v4'
method = 'main_v5_cdf_v10_freqtrun100'
default_setting = 'pr=0.9,n=30,beta=1.3,V=80'

for (. in 1:split) {
  for (freq_trun in c(100)){
    ### N_node
...
# top_level_folder = "../Results/Rdata"
# setup = 'SNR_Vnot0_v4'
# method = 'main_v5_cdf_v8_est_history_freqtrun20'
...
# 
# 
# method = 'main_v5_cdf_v8_est_history_freqtrun20/Our_init'
# for (. in 1:split) {
#   ### beta
#   for (i in 1:length(conn_patt_sep_list)) {
#     conn_patt_sep = conn_patt_sep_list[[i]]
