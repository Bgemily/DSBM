...
### Based on v3.2
### Calculate F_mse using pdf (rather than cdf), and include dt into calculation.
### Initial time shift are set as zero.

main_v3.2.1 = function(### Parameters for generative model
...
# Get initialization ------------------------------------------------------
  res = get_init_v3(edge_time_mat_list = edge_time_mat_list, N_clus = N_clus, 
                    v_true_list = v_true_list, jitter_time_rad = 0, 
                    t_vec = t_vec)
...
# Apply algorithm ---------------------------------------------------------
  ...
  ### V12
  res = do_cluster_v12(edge_time_mat_list = edge_time_mat_list, N_clus = N_clus,
